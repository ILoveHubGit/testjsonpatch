...
; (def prefix "/")
; (= (set obj1) (set obj2))
; (not= (first obj1) (first obj2))
; (and (map? (first obj1)) (map? (first obj2)))
; (conj [] (diff* (first obj1) (first obj2) (str prefix 0 "/")))
; (gen-op ["replace" (str prefix 0) (first obj2)])
;
; (diff-vecs obj1 obj2 prefix)
