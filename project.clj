(defproject testjsonpatch "0.1.0-SNAPSHOT"
  ...
  :test-paths ["test/clj"]
  :resource-paths ["resources" "target/cljsbuild" "resources/lib/clj-json-patch-0.1.8.jar"]
  :target-path "target/%s/"
  :main ^:skip-aot testjsonpatch.core
  ...
  {:nrepl {:port 7002}
   ...
   {:app
    {:target :browser
     ...
     :asset-path "/js"
     :modules {:app {:entries [testjsonpatch.app]}}
     :devtools
  ...
  {:uberjar {:omit-source true
             ...
             :aot :all
             :uberjar-name "testjsonpatch.jar"
